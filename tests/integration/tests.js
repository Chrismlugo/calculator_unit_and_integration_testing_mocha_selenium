...
describe('calculator functionality', function() {
  ...
  it('should have a working / operator__displays decimals', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('should be able to chain multiple operations together__displays negatives', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number4')).click();
    element(by.css('#operator_add')).click();
    element(by.css('#number4')).click();
  ...
  it('can display an error when dividing by zero', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number2')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number0')).click();
  ...
  it('can handle large numbers', function(){
    ...
    expect(running_total.getAttribute('value')).to.eventually.equal('9.5367431640625e+23');
